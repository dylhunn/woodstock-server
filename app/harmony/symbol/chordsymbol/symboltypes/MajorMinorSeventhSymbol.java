...
public class MajorMinorSeventhSymbol extends SeventhSymbol {

	public MajorMinorSeventhSymbol(Pitch root, Inversion inversion) {
		super(root, inversion);
		// TODO Auto-generated constructor stub
	}

	public MajorMinorSeventhSymbol(Pitch root, Inversion inversion, Set<ChordSymbolAlteration> modifications,
			Optional<ChordConstraint> constraint) {
		super(root, inversion, modifications, constraint);
		// TODO Auto-generated constructor stub
	}

	public MajorMinorSeventhSymbol(Pitch root, Pitch bass, Set<ChordSymbolAlteration> modifications, Optional<ChordConstraint> constraint) {
	...
	protected String name() {
		return "Major-Minor Seventh Chord";
	}
}
