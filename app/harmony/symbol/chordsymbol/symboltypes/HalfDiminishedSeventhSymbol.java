...
public class HalfDiminishedSeventhSymbol extends SeventhSymbol {

	public HalfDiminishedSeventhSymbol(Pitch root, Inversion inversion) {
		super(root, inversion);
		// TODO Auto-generated constructor stub
	}

	public HalfDiminishedSeventhSymbol(Pitch root, Inversion inversion, Set<ChordSymbolAlteration> modifications,
			Optional<ChordConstraint> constraint) {
		super(root, inversion, modifications, constraint);
		// TODO Auto-generated constructor stub
	}

	public HalfDiminishedSeventhSymbol(Pitch root, Pitch bass, Set<ChordSymbolAlteration> modifications,
			Optional<ChordConstraint> constraint) {
	...
	protected Set<Pitch> chordPitchesWithoutModifications() {
		...
		pitches.add(new Interval(new Note(ROOT, -1), 5, new IntervalQuality(IntervalQuality.Type.DIMINISHED),
				Pitch.Role.FIFTH).HIGH_NOTE.PITCH);
		pitches.add(
				new Interval(new Note(ROOT, -1), 7, new IntervalQuality(IntervalQuality.Type.MINOR), Pitch.Role.SEVENTH).HIGH_NOTE.PITCH);
		return pitches;
	}
