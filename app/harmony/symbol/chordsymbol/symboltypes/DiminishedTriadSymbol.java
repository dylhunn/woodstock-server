...
public class DiminishedTriadSymbol extends TriadSymbol {

	public DiminishedTriadSymbol(Pitch root, Inversion inversion) {
		super(root, inversion);
	}

	public DiminishedTriadSymbol(Pitch root, Inversion inversion, Set<ChordSymbolAlteration> modifications,
			Optional<ChordConstraint> constraint) {
		super(root, inversion, modifications, constraint);
	}

	public DiminishedTriadSymbol(Pitch root, Pitch bass, Set<ChordSymbolAlteration> modifications, Optional<ChordConstraint> constraint) {
	...
	protected Set<Pitch> chordPitchesWithoutModifications() {
		...
		pitches.add(ROOT);
		// -1 used for pitch class because Note object is temporary and local; TODO clean this up
