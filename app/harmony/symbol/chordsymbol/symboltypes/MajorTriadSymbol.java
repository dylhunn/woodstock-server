...
public class MajorTriadSymbol extends TriadSymbol {

	public MajorTriadSymbol(Pitch root, Inversion inversion) {
		super(root, inversion);
	}

	public MajorTriadSymbol(Pitch root, Inversion inversion, Set<ChordSymbolAlteration> modifications,
			Optional<ChordConstraint> constraint) {
		super(root, inversion, modifications, constraint);
	}

	public MajorTriadSymbol(Pitch root, Pitch bass, Set<ChordSymbolAlteration> modifications, Optional<ChordConstraint> constraint) {
